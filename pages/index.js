        ...
        <section className = "min-h-screen">
          <nav className='flex justify-between py-10 mb-5'>
            ...
            <ul className='flex items-center'>
              ...
              <li className=' bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-4 text-xs md:text-base'><a href={resume} target="_blank" rel="noneferrer">Resume</a></li>
            </ul>
          </nav>
